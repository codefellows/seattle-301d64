...
function displayPics(){
  ...
  After changing all the vars to let i got this message from the browser console: ReferenceError: rando is not defined

  Var is function scoped while let is block-scoped; when we change it to var it goes within the logic.

  Const is good for anything that wont change and also you wont want to use it in for loops as timers.
