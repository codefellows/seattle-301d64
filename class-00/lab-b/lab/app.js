...
let sum = function(a, b, c, d) {return `${a + b + c + d}`;};
...
/*
Because the 'this' is interpreted as 'undefined' because an arrow function automatically binds the context. even though an arrow function looks more concise its not an alternative to the regular function... or I dont know how to make them work togethere yet.
*/
...
//I think it has to do with the constructor.
// 2. What is "this" when joe.scopeArrow() is invoked?
//It somehow opens the window scope of the html document.
// 3. Explain why "this" is different when an arrow function is used.
//It has to do with lexical scoping, and an example is how we had to look at the prototype that woulnt work with Joe's greeting.
