...
console.log(objectLit(['nothing was', 'in', 'here?'])); // it was outputting an error, as there was no array to fill in objectLit?
...
// TODO: After viewing the previous console.log(), return the code to a working state. // Which was to create a standard constructor, no arrow notation? https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions says that arrow functions CANNOT be "new" constructors.
...
// Unknown, as it returns "undefined". So, if in that case, there is no "this".
